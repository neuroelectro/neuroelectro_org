...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('neurotree_node', 'lastname', self.gf('django.db.models.fields.CharField')(max_length=75))
    ...
    models = {
        ...
        'neurotree.node': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lastname': ('django.db.models.fields.CharField', [], {'max_length': '75'}),
