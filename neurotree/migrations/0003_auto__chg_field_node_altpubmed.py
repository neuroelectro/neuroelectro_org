...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Node.altpubmed'
        db.alter_column('neurotree_node', 'altpubmed', self.gf('django.db.models.fields.CharField')(max_length=400))

    def backwards(self, orm):

        # Changing field 'Node.altpubmed'
        db.alter_column('neurotree_node', 'altpubmed', self.gf('django.db.models.fields.URLField')(max_length=200))
    ...
    models = {
        ...
        'neurotree.node': {
            ...
            'altpubmed': ('django.db.models.fields.CharField', [], {'max_length': '400'}),
