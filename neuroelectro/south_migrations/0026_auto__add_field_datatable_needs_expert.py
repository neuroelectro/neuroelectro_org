...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('neuroelectro_datatable', 'needs_expert', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DataTable.needs_expert'
        db.delete_column('neuroelectro_datatable', 'needs_expert')
