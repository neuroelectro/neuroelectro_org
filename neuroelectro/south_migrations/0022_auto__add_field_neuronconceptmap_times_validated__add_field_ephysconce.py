...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NeuronConceptMap.times_validated'
        db.add_column('neuroelectro_neuronconceptmap', 'times_validated', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Adding field 'EphysConceptMap.times_validated'
        db.add_column('neuroelectro_ephysconceptmap', 'times_validated', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NeuronConceptMap.times_validated'
        db.delete_column('neuroelectro_neuronconceptmap', 'times_validated')

        # Deleting field 'EphysConceptMap.times_validated'
        db.delete_column('neuroelectro_ephysconceptmap', 'times_validated')
    ...
    models = {
        ...
        'neuroelectro.ephysconceptmap': {
            ...
            'times_validated': ('django.db.models.fields.IntegerField', [], {'null': 'True'})
        },
