...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'NeuronEphysSummary'
        db.create_table('neuroelectro_neuronephyssummary', (
            ...
            ('num_nedms', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ...
            ('value_mean', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('value_sd', self.gf('django.db.models.fields.FloatField')(null=True)),
        ))
        db.send_create_signal('neuroelectro', ['NeuronEphysSummary'])

        # Adding field 'EphysPropSummary.value_mean_neurons'
        db.add_column('neuroelectro_ephyspropsummary', 'value_mean_neurons', self.gf('django.db.models.fields.FloatField')(null=True), keep_default=False)

        # Adding field 'EphysPropSummary.value_mean_articles'
        db.add_column('neuroelectro_ephyspropsummary', 'value_mean_articles', self.gf('django.db.models.fields.FloatField')(null=True), keep_default=False)

        # Adding field 'EphysPropSummary.value_sd_neurons'
        db.add_column('neuroelectro_ephyspropsummary', 'value_sd_neurons', self.gf('django.db.models.fields.FloatField')(null=True), keep_default=False)

        # Adding field 'EphysPropSummary.value_sd_articles'
        db.add_column('neuroelectro_ephyspropsummary', 'value_sd_articles', self.gf('django.db.models.fields.FloatField')(null=True), keep_default=False)

        # Adding field 'NeuronEphysDataMap.val_norm'
        db.add_column('neuroelectro_neuronephysdatamap', 'val_norm', self.gf('django.db.models.fields.FloatField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'NeuronEphysSummary'
        db.delete_table('neuroelectro_neuronephyssummary')

        # Deleting field 'EphysPropSummary.value_mean_neurons'
        db.delete_column('neuroelectro_ephyspropsummary', 'value_mean_neurons')

        # Deleting field 'EphysPropSummary.value_mean_articles'
        db.delete_column('neuroelectro_ephyspropsummary', 'value_mean_articles')

        # Deleting field 'EphysPropSummary.value_sd_neurons'
        db.delete_column('neuroelectro_ephyspropsummary', 'value_sd_neurons')

        # Deleting field 'EphysPropSummary.value_sd_articles'
        db.delete_column('neuroelectro_ephyspropsummary', 'value_sd_articles')

        # Deleting field 'NeuronEphysDataMap.val_norm'
        db.delete_column('neuroelectro_neuronephysdatamap', 'val_norm')
