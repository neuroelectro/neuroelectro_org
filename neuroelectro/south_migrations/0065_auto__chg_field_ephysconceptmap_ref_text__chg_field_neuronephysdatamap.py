...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('neuroelectro_ephysconceptmap', 'ref_text', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'NeuronEphysDataMap.ref_text'
        db.alter_column('neuroelectro_neuronephysdatamap', 'ref_text', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
        # Adding field 'UserSubmission.article'
        db.add_column('neuroelectro_usersubmission', 'article',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['neuroelectro.Article'], null=True),
                      keep_default=False)


        # Changing field 'NeuronConceptMap.ref_text'
        db.alter_column('neuroelectro_neuronconceptmap', 'ref_text', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'EphysConceptMap.ref_text'
        db.alter_column('neuroelectro_ephysconceptmap', 'ref_text', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'NeuronEphysDataMap.ref_text'
        db.alter_column('neuroelectro_neuronephysdatamap', 'ref_text', self.gf('django.db.models.fields.CharField')(default='', max_length=200))
        # Deleting field 'UserSubmission.article'
        db.delete_column('neuroelectro_usersubmission', 'article_id')


        # Changing field 'NeuronConceptMap.ref_text'
        db.alter_column('neuroelectro_neuronconceptmap', 'ref_text', self.gf('django.db.models.fields.CharField')(default='', max_length=200))
