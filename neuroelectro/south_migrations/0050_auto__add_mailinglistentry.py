...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MailingListEntry'
        db.create_table('neuroelectro_mailinglistentry', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True)),
            ('comments', self.gf('django.db.models.fields.CharField')(max_length=500, null=True)),
        ))
        db.send_create_signal('neuroelectro', ['MailingListEntry'])


    def backwards(self, orm):
        # Deleting model 'MailingListEntry'
        db.delete_table('neuroelectro_mailinglistentry')
    ...
    models = {
        ...
        'neuroelectro.ephysconceptmap': {
            ...
            'added_by_old': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'date_mod': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
