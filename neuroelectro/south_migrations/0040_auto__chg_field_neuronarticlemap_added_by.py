...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('neuroelectro_neuronarticlemap', 'added_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['neuroelectro.User'], null=True))

    def backwards(self, orm):

        # Changing field 'NeuronArticleMap.added_by'
        db.alter_column('neuroelectro_neuronarticlemap', 'added_by_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['neuroelectro.User']))
