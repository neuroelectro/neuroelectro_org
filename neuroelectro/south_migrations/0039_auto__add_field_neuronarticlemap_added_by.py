...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NeuronArticleMap.added_by'
        db.add_column('neuroelectro_neuronarticlemap', 'added_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['neuroelectro.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NeuronArticleMap.added_by'
        db.delete_column('neuroelectro_neuronarticlemap', 'added_by_id')
    ...
    models = {
        ...
        'neuroelectro.neuronarticlemap': {
            ...
            'added_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['neuroelectro.User']"}),
