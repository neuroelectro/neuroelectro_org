...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('neuroelectro_articlefulltextstat', 'methods_tag_found',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'MetaData.added_by'
        db.add_column('neuroelectro_metadata', 'added_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['neuroelectro.User'], null=True),
                      keep_default=False)

        # Adding field 'MetaData.times_validated'
        db.add_column('neuroelectro_metadata', 'times_validated',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ArticleFullTextStat.methods_tag_found'
        db.delete_column('neuroelectro_articlefulltextstat', 'methods_tag_found')

        # Deleting field 'MetaData.added_by'
        db.delete_column('neuroelectro_metadata', 'added_by_id')

        # Deleting field 'MetaData.times_validated'
        db.delete_column('neuroelectro_metadata', 'times_validated')
