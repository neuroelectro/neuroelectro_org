...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'User.institution'
        db.alter_column('neuroelectro_user', 'institution_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['neuroelectro.Institution'], null=True))

    def backwards(self, orm):

        # Changing field 'User.institution'
        db.alter_column('neuroelectro_user', 'institution_id', self.gf('django.db.models.fields.related.ForeignKey')(default=datetime.datetime(2012, 12, 14, 0, 0), to=orm['neuroelectro.Institution']))
