...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.lab_head'
        db.add_column('neuroelectro_user', 'lab_head',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'User.lab_website_url'
        db.add_column('neuroelectro_user', 'lab_website_url',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True),
                      keep_default=False)

        # Adding field 'User.last_update'
        db.add_column('neuroelectro_user', 'last_update',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'User.is_curator'
        db.add_column('neuroelectro_user', 'is_curator',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding M2M table for field assigned_neurons on 'User'
        db.create_table('neuroelectro_user_assigned_neurons', (
        ...
        db.create_unique('neuroelectro_user_assigned_neurons', ['user_id', 'neuron_id'])


    def backwards(self, orm):
        # Deleting field 'User.lab_head'
        db.delete_column('neuroelectro_user', 'lab_head')

        # Deleting field 'User.lab_website_url'
        db.delete_column('neuroelectro_user', 'lab_website_url')

        # Deleting field 'User.last_update'
        db.delete_column('neuroelectro_user', 'last_update')

        # Deleting field 'User.is_curator'
        db.delete_column('neuroelectro_user', 'is_curator')

        # Removing M2M table for field assigned_neurons on 'User'
        db.delete_table('neuroelectro_user_assigned_neurons')
