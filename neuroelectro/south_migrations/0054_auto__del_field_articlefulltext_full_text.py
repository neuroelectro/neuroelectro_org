...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ArticleFullText.full_text'
        db.delete_column('neuroelectro_articlefulltext', 'full_text')


    def backwards(self, orm):
        # Adding field 'ArticleFullText.full_text'
        db.add_column('neuroelectro_articlefulltext', 'full_text',
