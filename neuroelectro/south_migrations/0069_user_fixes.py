...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding the extended fields to the base model, 
        # since there are fewer of them and I know what 
        # they look like.  

        # Adding field 'User.lab_head'
        db.add_column('auth_user', 'lab_head',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'User.lab_website_url'
        db.add_column('auth_user', 'lab_website_url',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True),
                      keep_default=False)

        # Adding field 'User.last_update'
        db.add_column('auth_user', 'last_update',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'User.is_curator'
        db.add_column('auth_user', 'is_curator',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'User.institution'
        db.add_column('auth_user', 'institution',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['neuroelectro.Institution']), keep_default=False)

        #db.rename_table('neuroelectro_userold')
