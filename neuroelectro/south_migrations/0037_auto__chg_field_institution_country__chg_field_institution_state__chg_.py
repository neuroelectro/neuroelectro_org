...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Institution.country'
        db.alter_column('neuroelectro_institution', 'country', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Institution.state'
        db.alter_column('neuroelectro_institution', 'state', self.gf('django.db.models.fields.CharField')(max_length=2, null=True))

        # Changing field 'Institution.type'
        db.alter_column('neuroelectro_institution', 'type', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'Institution.country'
        db.alter_column('neuroelectro_institution', 'country', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

        # Changing field 'Institution.state'
        db.alter_column('neuroelectro_institution', 'state', self.gf('django.db.models.fields.CharField')(default='', max_length=2))

        # Changing field 'Institution.type'
        db.alter_column('neuroelectro_institution', 'type', self.gf('django.db.models.fields.CharField')(default='', max_length=50))
