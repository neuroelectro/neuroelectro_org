...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('neuroelectro_ephysconceptmap', 'added_by_old')

        # Deleting field 'NeuronEphysDataMap.added_by_old'
        db.delete_column('neuroelectro_neuronephysdatamap', 'added_by_old')

        # Deleting field 'NeuronConceptMap.added_by_old'
        db.delete_column('neuroelectro_neuronconceptmap', 'added_by_old')


    def backwards(self, orm):
        # Adding field 'EphysConceptMap.added_by_old'
        db.add_column('neuroelectro_ephysconceptmap', 'added_by_old',
                      self.gf('django.db.models.fields.CharField')(default='robot', max_length=200),
                      keep_default=False)

        # Adding field 'NeuronEphysDataMap.added_by_old'
        db.add_column('neuroelectro_neuronephysdatamap', 'added_by_old',
                      self.gf('django.db.models.fields.CharField')(default='robot', max_length=200),
                      keep_default=False)

        # Adding field 'NeuronConceptMap.added_by_old'
        db.add_column('neuroelectro_neuronconceptmap', 'added_by_old',
                      self.gf('django.db.models.fields.CharField')(default='robot', max_length=200),
                      keep_default=False)
