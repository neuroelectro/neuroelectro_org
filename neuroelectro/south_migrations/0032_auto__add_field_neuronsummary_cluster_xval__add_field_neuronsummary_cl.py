...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('neuroelectro_neuronsummary', 'cluster_xval', self.gf('django.db.models.fields.FloatField')(null=True), keep_default=False)

        # Adding field 'NeuronSummary.cluster_yval'
        db.add_column('neuroelectro_neuronsummary', 'cluster_yval', self.gf('django.db.models.fields.FloatField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NeuronSummary.cluster_xval'
        db.delete_column('neuroelectro_neuronsummary', 'cluster_xval')

        # Deleting field 'NeuronSummary.cluster_yval'
        db.delete_column('neuroelectro_neuronsummary', 'cluster_yval')
