...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'neuroelectro_uservalidation', (
        ...
        db.send_create_signal(u'neuroelectro', ['UserValidation'])

        # Adding M2M table for field validated_by on 'ArticleMetaDataMap'
        m2m_table_name = db.shorten_name(u'neuroelectro_articlemetadatamap_validated_by')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('articlemetadatamap', models.ForeignKey(orm[u'neuroelectro.articlemetadatamap'], null=False)),
            ('uservalidation', models.ForeignKey(orm[u'neuroelectro.uservalidation'], null=False))
        ))
        db.create_unique(m2m_table_name, ['articlemetadatamap_id', 'uservalidation_id'])

        # Adding M2M table for field validated_by on 'EphysConceptMap'
        m2m_table_name = db.shorten_name(u'neuroelectro_ephysconceptmap_validated_by')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('ephysconceptmap', models.ForeignKey(orm[u'neuroelectro.ephysconceptmap'], null=False)),
            ('uservalidation', models.ForeignKey(orm[u'neuroelectro.uservalidation'], null=False))
        ))
        db.create_unique(m2m_table_name, ['ephysconceptmap_id', 'uservalidation_id'])

        # Adding M2M table for field validated_by on 'NeuronEphysDataMap'
        m2m_table_name = db.shorten_name(u'neuroelectro_neuronephysdatamap_validated_by')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('neuronephysdatamap', models.ForeignKey(orm[u'neuroelectro.neuronephysdatamap'], null=False)),
            ('uservalidation', models.ForeignKey(orm[u'neuroelectro.uservalidation'], null=False))
        ))
        db.create_unique(m2m_table_name, ['neuronephysdatamap_id', 'uservalidation_id'])

        # Deleting field 'Article.suggester'
        db.delete_column(u'neuroelectro_article', 'suggester_id')

        # Adding M2M table for field validated_by on 'NeuronConceptMap'
        m2m_table_name = db.shorten_name(u'neuroelectro_neuronconceptmap_validated_by')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('neuronconceptmap', models.ForeignKey(orm[u'neuroelectro.neuronconceptmap'], null=False)),
            ('uservalidation', models.ForeignKey(orm[u'neuroelectro.uservalidation'], null=False))
        ))
        db.create_unique(m2m_table_name, ['neuronconceptmap_id', 'uservalidation_id'])


    def backwards(self, orm):
        # Deleting model 'UserValidation'
        db.delete_table(u'neuroelectro_uservalidation')

        # Removing M2M table for field validated_by on 'ArticleMetaDataMap'
        db.delete_table(db.shorten_name(u'neuroelectro_articlemetadatamap_validated_by'))

        # Removing M2M table for field validated_by on 'EphysConceptMap'
        db.delete_table(db.shorten_name(u'neuroelectro_ephysconceptmap_validated_by'))

        # Removing M2M table for field validated_by on 'NeuronEphysDataMap'
        db.delete_table(db.shorten_name(u'neuroelectro_neuronephysdatamap_validated_by'))

        # Adding field 'Article.suggester'
        db.add_column(u'neuroelectro_article', 'suggester',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['neuroelectro.User'], null=True),
                      keep_default=False)

        # Removing M2M table for field validated_by on 'NeuronConceptMap'
        db.delete_table(db.shorten_name(u'neuroelectro_neuronconceptmap_validated_by'))
