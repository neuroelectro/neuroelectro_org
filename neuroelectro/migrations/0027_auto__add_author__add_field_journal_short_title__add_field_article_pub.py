...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Author'
        db.create_table('neuroelectro_author', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('first', self.gf('django.db.models.fields.CharField')(max_length=100, null=True)),
            ('last', self.gf('django.db.models.fields.CharField')(max_length=100, null=True)),
            ('intials', self.gf('django.db.models.fields.CharField')(max_length=10, null=True)),
        ))
        db.send_create_signal('neuroelectro', ['Author'])

        # Adding field 'Journal.short_title'
        db.add_column('neuroelectro_journal', 'short_title', self.gf('django.db.models.fields.CharField')(max_length=100, null=True), keep_default=False)

        # Adding field 'Article.pub_year'
        db.add_column('neuroelectro_article', 'pub_year', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Adding M2M table for field authors on 'Article'
        db.create_table('neuroelectro_article_authors', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('article', models.ForeignKey(orm['neuroelectro.article'], null=False)),
            ('author', models.ForeignKey(orm['neuroelectro.author'], null=False))
        ))
        db.create_unique('neuroelectro_article_authors', ['article_id', 'author_id'])


    def backwards(self, orm):
        
        # Deleting model 'Author'
        db.delete_table('neuroelectro_author')

        # Deleting field 'Journal.short_title'
        db.delete_column('neuroelectro_journal', 'short_title')

        # Deleting field 'Article.pub_year'
        db.delete_column('neuroelectro_article', 'pub_year')

        # Removing M2M table for field authors on 'Article'
        db.delete_table('neuroelectro_article_authors')
    ...
    models = {
        ...
        'neuroelectro.author': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'intials': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True'}),
