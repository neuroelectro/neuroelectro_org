...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        print users.count()
        for user in users:
            db.execute("UPDATE auth_user as a,neuroelectro_user as n SET \
                a.institution_id = n.institution_id, \
                a.lab_head = n.lab_head, \
                a.lab_website_url = n.lab_website_url, \
                a.last_update = n.last_update, \
                a.is_curator = n.is_curator \
                        WHERE a.id=n.id")
