...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('neuroelectro_articlesummary', 'author_list_str')


    def backwards(self, orm):
        # Adding field 'ArticleSummary.author_list_str'
        db.add_column('neuroelectro_articlesummary', 'author_list_str',
