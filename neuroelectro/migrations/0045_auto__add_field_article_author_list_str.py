...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.author_list_str'
        db.add_column('neuroelectro_article', 'author_list_str',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.author_list_str'
        db.delete_column('neuroelectro_article', 'author_list_str')
