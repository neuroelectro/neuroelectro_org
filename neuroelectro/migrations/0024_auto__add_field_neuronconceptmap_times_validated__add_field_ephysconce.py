...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('neuroelectro_neuronconceptmap', 'times_validated', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'EphysConceptMap.times_validated'
        db.add_column('neuroelectro_ephysconceptmap', 'times_validated', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
