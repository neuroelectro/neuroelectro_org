...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('neuroelectro_publisher', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('neuroelectro', ['Publisher'])

        # Adding field 'Journal.publisher'
        db.add_column('neuroelectro_journal', 'publisher',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['neuroelectro.Publisher'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Publisher'
        db.delete_table('neuroelectro_publisher')

        # Deleting field 'Journal.publisher'
        db.delete_column('neuroelectro_journal', 'publisher_id')
