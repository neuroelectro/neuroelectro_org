...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('neuroelectro_article', 'suggester_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['neuroelectro.User'], null=True))

    def backwards(self, orm):

        # Changing field 'Article.suggester'
        db.alter_column('neuroelectro_article', 'suggester_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['neuroelectro.User']))
