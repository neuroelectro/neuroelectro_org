...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NeuronEphysDataMap.norm_flag'
        db.add_column(u'neuroelectro_neuronephysdatamap', 'norm_flag',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NeuronEphysDataMap.norm_flag'
        db.delete_column(u'neuroelectro_neuronephysdatamap', 'norm_flag')
