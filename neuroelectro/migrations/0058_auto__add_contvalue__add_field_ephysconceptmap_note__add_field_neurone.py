...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ContValue'
        db.create_table('neuroelectro_contvalue', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('mean', self.gf('django.db.models.fields.FloatField')()),
            ('stdev', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('stderr', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('min_range', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('max_range', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('n', self.gf('django.db.models.fields.IntegerField')(null=True)),
        ))
        db.send_create_signal('neuroelectro', ['ContValue'])

        # Adding field 'EphysConceptMap.note'
        db.add_column('neuroelectro_ephysconceptmap', 'note',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True),
                      keep_default=False)

        # Adding field 'NeuronEphysDataMap.note'
        db.add_column('neuroelectro_neuronephysdatamap', 'note',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True),
                      keep_default=False)

        # Adding field 'ArticleFullTextStat.metadata_human_assigned'
        db.add_column('neuroelectro_articlefulltextstat', 'metadata_human_assigned',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ArticleFullTextStat.num_unique_ephys_concept_maps'
        db.add_column('neuroelectro_articlefulltextstat', 'num_unique_ephys_concept_maps',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'NeuronConceptMap.note'
        db.add_column('neuroelectro_neuronconceptmap', 'note',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True),
                      keep_default=False)

        # Adding field 'MetaData.cont_value'
        db.add_column('neuroelectro_metadata', 'cont_value',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['neuroelectro.ContValue'], null=True),
                      keep_default=False)

        # Adding field 'MetaData.note'
        db.add_column('neuroelectro_metadata', 'note',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True),
                      keep_default=False)


        # Changing field 'MetaData.value'
        db.alter_column('neuroelectro_metadata', 'value', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):
        # Deleting model 'ContValue'
        db.delete_table('neuroelectro_contvalue')

        # Deleting field 'EphysConceptMap.note'
        db.delete_column('neuroelectro_ephysconceptmap', 'note')

        # Deleting field 'NeuronEphysDataMap.note'
        db.delete_column('neuroelectro_neuronephysdatamap', 'note')

        # Deleting field 'ArticleFullTextStat.metadata_human_assigned'
        db.delete_column('neuroelectro_articlefulltextstat', 'metadata_human_assigned')

        # Deleting field 'ArticleFullTextStat.num_unique_ephys_concept_maps'
        db.delete_column('neuroelectro_articlefulltextstat', 'num_unique_ephys_concept_maps')

        # Deleting field 'NeuronConceptMap.note'
        db.delete_column('neuroelectro_neuronconceptmap', 'note')

        # Deleting field 'MetaData.cont_value'
        db.delete_column('neuroelectro_metadata', 'cont_value_id')

        # Deleting field 'MetaData.note'
        db.delete_column('neuroelectro_metadata', 'note')


        # Changing field 'MetaData.value'
        db.alter_column('neuroelectro_metadata', 'value', self.gf('django.db.models.fields.CharField')(default=None, max_length=100))
