...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'EphysPropSummary.num_nemds'
        db.delete_column('neuroelectro_ephyspropsummary', 'num_nemds')

        # Adding field 'EphysPropSummary.num_nedms'
        db.add_column('neuroelectro_ephyspropsummary', 'num_nedms', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Deleting field 'NeuronSummary.num_nemds'
        db.delete_column('neuroelectro_neuronsummary', 'num_nemds')

        # Adding field 'NeuronSummary.num_nedms'
        db.add_column('neuroelectro_neuronsummary', 'num_nedms', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Deleting field 'ArticleSummary.num_nemds'
        db.delete_column('neuroelectro_articlesummary', 'num_nemds')

        # Adding field 'ArticleSummary.num_nedms'
        db.add_column('neuroelectro_articlesummary', 'num_nedms', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'EphysPropSummary.num_nemds'
        db.add_column('neuroelectro_ephyspropsummary', 'num_nemds', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Deleting field 'EphysPropSummary.num_nedms'
        db.delete_column('neuroelectro_ephyspropsummary', 'num_nedms')

        # Adding field 'NeuronSummary.num_nemds'
        db.add_column('neuroelectro_neuronsummary', 'num_nemds', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Deleting field 'NeuronSummary.num_nedms'
        db.delete_column('neuroelectro_neuronsummary', 'num_nedms')

        # Adding field 'ArticleSummary.num_nemds'
        db.add_column('neuroelectro_articlesummary', 'num_nemds', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Deleting field 'ArticleSummary.num_nedms'
        db.delete_column('neuroelectro_articlesummary', 'num_nedms')
