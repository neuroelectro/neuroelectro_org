...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Protein.entrezid'
        db.alter_column('neuroelectro_protein', 'entrezid', self.gf('django.db.models.fields.IntegerField')(null=True))
        # Deleting field 'RegionExpr.val'
        db.delete_column('neuroelectro_regionexpr', 'val')

        # Adding field 'RegionExpr.expr_energy'
        db.add_column('neuroelectro_regionexpr', 'expr_energy',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)

        # Adding field 'RegionExpr.expr_density'
        db.add_column('neuroelectro_regionexpr', 'expr_density',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)

        # Adding field 'RegionExpr.expr_energy_cv'
        db.add_column('neuroelectro_regionexpr', 'expr_energy_cv',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Protein.entrezid'
        db.alter_column('neuroelectro_protein', 'entrezid', self.gf('django.db.models.fields.IntegerField')(default=0))
        # Adding field 'RegionExpr.val'
        db.add_column('neuroelectro_regionexpr', 'val',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Deleting field 'RegionExpr.expr_energy'
        db.delete_column('neuroelectro_regionexpr', 'expr_energy')

        # Deleting field 'RegionExpr.expr_density'
        db.delete_column('neuroelectro_regionexpr', 'expr_density')

        # Deleting field 'RegionExpr.expr_energy_cv'
        db.delete_column('neuroelectro_regionexpr', 'expr_energy_cv')
