...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column('neuroelectro_ephysconceptmap', 'added_by', 'added_by_old')

        # Deleting field 'NeuronEphysDataMap.added_by'
        db.rename_column('neuroelectro_neuronephysdatamap', 'added_by', 'added_by_old')

        # Deleting field 'NeuronConceptMap.added_by'
        db.rename_column('neuroelectro_neuronconceptmap', 'added_by', 'added_by_old')


    def backwards(self, orm):
        # Adding field 'EphysConceptMap.added_by'
        db.add_column('neuroelectro_ephysconceptmap', 'added_by',
                      self.gf('django.db.models.fields.CharField')(default='robot', max_length=20),
                      keep_default=False)
