...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Author.initials'
        db.add_column('neuroelectro_author', 'initials', self.gf('django.db.models.fields.CharField')(max_length=10, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Author.intials'
        db.add_column('neuroelectro_author', 'intials', self.gf('django.db.models.fields.CharField')(max_length=10, null=True), keep_default=False)

        # Deleting field 'Author.initials'
        db.delete_column('neuroelectro_author', 'initials')
