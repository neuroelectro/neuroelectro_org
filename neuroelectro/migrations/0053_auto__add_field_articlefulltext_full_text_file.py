...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ArticleFullText.full_text_file'
        db.add_column('neuroelectro_articlefulltext', 'full_text_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ArticleFullText.full_text_file'
        db.delete_column('neuroelectro_articlefulltext', 'full_text_file')
