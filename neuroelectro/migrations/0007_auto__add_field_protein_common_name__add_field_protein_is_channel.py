...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Protein.common_name'
        db.add_column('neuroelectro_protein', 'common_name', self.gf('django.db.models.fields.CharField')(max_length=400, null=True), keep_default=False)

        # Adding field 'Protein.is_channel'
        db.add_column('neuroelectro_protein', 'is_channel', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Protein.common_name'
        db.delete_column('neuroelectro_protein', 'common_name')

        # Deleting field 'Protein.is_channel'
        db.delete_column('neuroelectro_protein', 'is_channel')
