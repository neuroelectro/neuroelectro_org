...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field exp_fact_concept_maps on 'NeuronEphysDataMap'
        m2m_table_name = db.shorten_name(u'neuroelectro_neuronephysdatamap_exp_fact_concept_maps')
        ...
        db.create_unique(m2m_table_name, ['neuronephysdatamap_id', 'expfactconceptmap_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field exp_fact_concept_maps on 'NeuronEphysDataMap'
        db.delete_table(db.shorten_name(u'neuroelectro_neuronephysdatamap_exp_fact_concept_maps'))
    ...
    models = {
        ...
        u'neuroelectro.neuronephysdatamap': {
            ...
            'exp_fact_concept_maps': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['neuroelectro.ExpFactConceptMap']", 'null': 'True', 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'match_quality': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'n': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
